...
$xml->record->addChild( "kategoria_wizy", $formularz['typ_wizy'] );
$xml->record->addChild( "ilość_wjazdów", $formularz['krotność_wizy'] );
...
$xml->record->addChild( "planowane_miejsca_odwiedzin", '---' );
